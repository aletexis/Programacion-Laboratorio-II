    ...
    class Program
    {
        static void Main(string[] args)
        {
           ...
           //Console.WriteLine(p.ObtenerInfoExtension());
            ...
            //Eventos.Entidades.Empleado e = new Eventos.Entidades.Empleado();

            //Console.WriteLine(e.ObtenerInfoExtension());
            ...
            //Eventos.Entidades.EmpleadoMejorado em = new Eventos.Entidades.EmpleadoMejorado();

            //if (em.Nombre.EsNulo())
            //{
            //    em.EstablecerNombreExtensionParam("Juancito");
            //}
