...
namespace _06_Xml
{
    class Program
    {
        ...
        { 
            ...
            try
            {
                using (XmlTextWriter writer = new XmlTextWriter("C:\\archivos\\DatosListaHerencia.xml", Encoding.UTF8))
                {
                ...
                using (XmlTextReader reader = new XmlTextReader("C:\\archivos\\DatosListaHerencia.xml"))
                {
                    XmlSerializer ser = new XmlSerializer((typeof(List<ClaseAbstracta>)));
