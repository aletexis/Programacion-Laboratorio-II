...
namespace Test
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Auto a2 = new Auto("C4", 285900, f2, ETipo.Deportivo); Auto a3 = new Auto("C4", 390500, f2, ETipo.Familiar); 
            Auto a4 = new Auto("C4", 96300, f1, ETipo.Deportivo); miConcesionaria += a1;
            ...
            //SIN LUGAR
            miConcesionaria += a4;
            Console.WriteLine(Concesionaria.Mostrar(miConcesionaria));Console.ReadLine();
        }
    }
}
